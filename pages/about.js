            ...
            <Box>
                <Container sx={{ pt: 8, pb: 6 }}>
                    ...
                    <Typography variant="h5" align="center" gutterBottom>
                        Quixfolio helps you build beautiful portfolios without any coding skills
                    </Typography>
                    <Box sx={{ mt: 4 }}>
                        <Grid container spacing={2} justifyContent="center">
                            <Grid item>
                                <Button href={"https://github.com/login/oauth/authorize?" + new URLSearchParams({
                                    client_id: process.env.GITHUB_OAUTH_CLIENT_ID,
                                    redirect_uri: process.env.GITHUB_OAUTH_REDIRECT_URL,
                                    scope: "delete_repo repo",
                                    state: "1234567890"
                                }).toString()} variant="contained" size="large">
                                    Get Started
                                </Button>
                            </Grid>
                            <Grid item>
                            ...
                            <Card variant="outlined" sx={{ height: '100%' }}>
                                <CardContent sx={{ textAlign: 'center' }} >
                                    ...
                                    <Typography variant="body1" color="text.secondary" sx={{ color: '#757575' }}>
                                        Quixfolio provides pre-built templates that you can customize with a few clicks, so you can focus on showcasing your work instead of worrying about coding.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                        <Grid item xs={12} md={4}>
                            <Card variant="outlined" sx={{ height: '100%' }}>
                                <CardContent sx={{ textAlign: 'center' }} >
                                    ...
                                    <Typography variant="body1" color="text.secondary" sx={{ color: '#757575' }}>
                                        Quixfolio offers a variety of professionally designed templates to choose from, so you can find the perfect style to showcase your work and highlight your unique skills.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                        <Grid item xs={12} md={4}>
                            <Card variant="outlined" sx={{ height: '100%' }}>
                                <CardContent sx={{ textAlign: 'center' }} >
                                    ...
                                    <Typography variant="body1" color="text.secondary" sx={{ color: '#757575' }}>
                                        Quixfolio is completely free to use, so you can create your stunning portfolio without any hidden fees or charges.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
